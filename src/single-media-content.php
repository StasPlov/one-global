...
<?php 
    $header_image = get_field('header_image', 'media-center-single');
...
<!-- next -->
<?php 
    $footer_button = get_field('footer_button', 'media-center-single');
    $footer_share = get_field('footer_share', 'media-center-single');
