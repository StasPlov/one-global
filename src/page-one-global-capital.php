        ...
        <div class="flex flex-1 items-center justify-center max-md:px-[2.1875rem]">
            <div class="flex flex-col items-start gap-28">
                <div class="flex flex-col gap-14">
                    <h2 class="text-[5rem] font-medium font-caudex italic text-start" id="view-anim" data-animation="animate-fadeInRight" data-duration="2.5s"><?php echo $about_title; ?></h2>
...
<div class="w-full min-h-screen bg-black relative">
    <img :src="require('@/Assets/Images/Ellipse 5 (2).svg')" alt="" class="absolute top-[10%] right-[8%] select-none" draggable="false">
...
<div class="min-h-screen w-full">
    <div class="flex flex-col">
        <div class="flex w-full px-[11.25rem] h-screen items-center relative max-md:px-[2.1875rem] max-md:py-[6.25rem]">
            <img :src="require('@/Assets/Images/Ellipse 8 (2).svg')" alt="" class="absolute top-[10%] left-0 select-none max-md:hidden" draggable="false">
