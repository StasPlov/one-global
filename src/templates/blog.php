...
<div class="w-full h-screen">
    <div class="w-full h-full grid grid-cols-2 items-center">
        ...
        <div class="flex-1 h-full">
            <img src="<?php echo $fields['image'] ?>" alt="image" class="h-full w-full object-cover">
        </div>
    </div>
</div>
...
<div class="w-full min-h-screen">
    <nav class="flex sticky top-[-1px] bg-white">
        <ul class="flex flex-[5]">
            <li class="flex flex-1 border border-solid border-[#1c212633] border-l-0">
                <a href="/blog" class="w-full h-full text-center px-[36px] py-[22px] transition hover:bg-gray-400/10 cursor-pointer">
                    <span class="text-[#1C2126] font-lato text-sm font-medium uppercase leading-7">All acrticle</span>   
                </a>
            </li>
            
            <?php foreach (wp_get_nav_menu_items(26) as $menu) : ?>
            <li class="flex flex-1 border border-solid border-[#1c212633] border-l-0">
                <a href="<?php echo $menu->url; ?>" class="w-full h-full text-center px-[36px] py-[22px] transition hover:bg-gray-400/10 cursor-pointer">
                    <span class="text-[#1C2126] font-lato text-sm font-medium uppercase leading-7"><?php echo $menu->title; ?></span>   
                </a>
            </li>
            <?php endforeach; ?>
        </ul>
            ...
            <div class="flex-[3] border-b border-solid border-[#1c212633]">
                <div class="flex flex-col pl-[52px] py-10 items-start justify-between h-full max-w-[738px]">
                    ...
                    <div class="flex flex-col gap-4">
                        ...
                        <div class="font-lato text-[#1C2126] text-base font-light leading-7 text-start"><?php echo the_excerpt(); ?></div>
                    </div>
