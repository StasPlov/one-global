...
<div class="relative w-full h-screen overflow-hidden" id="scroll-trigger2">
    ...
    <div class="px-[11.25rem] w-full h-full flex items-center justify-start max-md:px-[2.1875rem]">
        <?php $headerBgData = get_field('header_background', 'home-page'); ?>
        <video class="absolute w-full h-full object-cover top-0 left-0" autoplay loop muted poster="<?php echo $headerBgData['video']['icon']; ?>">
            <source src="<?php echo $headerBgData['video']['url']; ?>" type="video/mp4">
        </video>
        ...
        <div class="flex flex-col items-start gap-12">
            ...
            <button class="relative flex gap-2 justify-between items-center pl-11 pr-9 py-3 border border-solid border-white rounded-3xl transition duration-300 group hover:bg-[#1c2126] hover:border-transparent hover:after:opacity-100 cursor-pointer after:absolute after:transition after:duration-500 after:place-content-center after:pointer-events-none after:w-full after:h-full after:blur-[3.4375rem] after:bg-[#057eed] after:left-0 after:right-0 after:top-0 after:bottom-0 after:opacity-0" id="view-anim" data-animation="animate-fadeInLeft" data-duration="3s">
                <span class="text-white text-sm font-medium font-lato group-hover:text-white transition duration-300">Learn More</span>
                <div class="group-hover:animate-bounce">
                    <img src="<?php echo get_template_directory_uri().'/assets/Icons/arrow_rigth2.svg'?>" alt="" class="transition duration-300 group-hover:scale-x-150 group-hover:translate-x-3">
                </div>
            </button>
        </div>
        ...
        <div class="text-white max-md:hidden">
            ...
            <div class="absolute max-w-min text-start transition-all right-[20%]" id="scroll-anim2" style="animation-delay: calc(var(--scroll) * -1s);">
...
<div class="relative w-full h-screen overflow-hidden" id="scroll-trigger">
    ...
    <div class="absolute max-w-min text-start transition-all" id="scroll-anim">
        ...
        <div class="flex flex-1 items-center justify-center">
            <div class="flex flex-col gap-6 max-w-[33.125rem] max-md:px-[2.1875rem] max-md:gap-[4.375rem] text-start items-start sticky top-[var(--header-menu-height)]" id="view-anim" data-animation="animate-fadeInRight">
                ...
                <button class="relative flex gap-2 justify-between items-center pl-11 pr-9 py-3 border border-solid border-[#1c2126] rounded-3xl transition duration-300 group hover:bg-[#1c2126] hover:border-transparent hover:after:opacity-100 cursor-pointer after:absolute after:transition after:duration-500 after:place-content-center after:pointer-events-none after:w-full after:h-full after:blur-[3.4375rem] after:bg-[#057eed] after:left-0 after:right-0 after:top-0 after:bottom-0 after:opacity-0">
                    <span class="text-[#1C2126] text-sm font-medium font-lato group-hover:text-white transition duration-300">Learn More</span>
                    <div class="group-hover:animate-bounce">
...
<div class="flex min-h-screen items-center w-full relative">
    ...
    <div class="flex flex-col px-[11.25rem] max-md:px-[2.1875rem] max-md:pb-14 w-full h-full justify-center gap-[6.25rem]">
        <?php $headerOurPromiseTitleData = get_field('our_promise_title', 'home-page'); ?>
        <h2 class="font-lato font-medium text-[5rem] text-start max-w-[29.375rem] w-full" id="view-anim" data-animation="animate-fadeInTop" data-duration="1.5s"><?php echo $headerOurPromiseTitleData; ?></h2>

        <div class="flex max-md:flex-col justify-between gap-[8.3125rem] max-md:gap-14">
            <span class="max-w-[29.375rem]" id="view-anim" data-animation="animate-fadeInLeft" data-duration="1s">
                <?php $headerOurPromiseTextOneData = get_field('our_promise_text_one', 'home-page'); ?>
                <?php echo $headerOurPromiseTextOneData; ?>
            </span>

            <span class="max-w-[29.375rem]" id="view-anim" data-animation="animate-fadeInRight" data-duration="3s">
                <?php $headerOurPromiseTextTwoData = get_field('our_promise_text_two', 'home-page'); ?>
                <?php echo $headerOurPromiseTextOneData; ?>
            </span>
        </div>
    </div>
...
<div class="w-full min-h-screen relative">
    ...
    <div class="flex flex-col gap-[8.75rem] h-full items-center px-[11.25rem] max-md:px-[2.1875rem]">
        <?php $headerDigitalTitleData = get_field('digital_title', 'home-page'); ?> 
        <h2 class="font-caudex text-5xl leading-[3.5rem] italic max-w-[47.9375rem] max-md:max-w-none text-start" id="view-anim" data-animation="animate-fadeInLeft" data-duration="2s"><?php echo $headerDigitalTitleData; ?></h2>

        <div class="flex gap-11 items-start max-md:flex-col">
            <?php $headerDigitalInfoListData = get_field('digital_info_block', 'home-page'); ?> 
            <?php if(!empty($headerDigitalInfoListData)) : ?>
            <?php foreach ($headerDigitalInfoListData as $item) : ?>
            <div class="px-6 py-10 shadow-[0.625rem_0.625rem_1.25rem_0rem_#008AEE33] rounded-lg flex flex-col gap-10 max-w-[20.75rem] min-h-[26.5rem]" id="view-anim" data-animation="animate-fadeInLeft" data-duration="3s">
                ...
                <img src="<?php echo $item['icon']; ?>" alt="" class="max-w-[3.125rem]">
                <?php endif ?>
...
<!-- og capital -->
<?php $headerOgCapitalData = get_field('og_capital', 'home-page'); ?>
